 ...
 */
public abstract class FilteredElementList<E extends MuisElement> extends org.muis.core.mgr.AbstractElementList<E> {
	...
	public FilteredElementList(MuisElement parent, ElementList<? extends E> backing) {
		...
		theBacking.act(new org.observe.Action<ChildEvent>() {
			...
			org.muis.core.mgr.ImmutableChildList<MuisElement> filterList(org.muis.core.mgr.ImmutableChildList<MuisElement> list) {
				return new org.muis.core.mgr.ImmutableChildList<>(new FilteredElementList<MuisElement>(getParent(), list) {
					@Override
					...
					@Override
					protected void assertFits(MuisElement e) throws IllegalArgumentException {
					}
	 ...
	 */
	protected abstract void assertFits(MuisElement e) throws IllegalArgumentException;
