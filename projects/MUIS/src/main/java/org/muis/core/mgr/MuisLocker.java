...
public class MuisLocker {
	...
	/**
	 * Locks the hierarchy from an ancestor to a parent. If used with {@link MuisElement#CHILDREN_LOCK_TYPE}, this will ensure that the path
