...
/** An expression that can be evaluated on the {@link org.quick.core.mgr.StateEngine state} of an element */
public abstract class StateExpression implements org.quick.core.style.StyleExpression<StateExpression>, Comparable<StateExpression> {
