...
public class AttributeAcceptedEventCondition implements QuickEventCondition<AttributeAcceptedEvent> {
	/** Filters all {@link AttributeAcceptedEvent}s */
	public static final java.util.function.Function<QuickEvent, AttributeAcceptedEvent> base = value -> {
	...
	@Override
	public AttributeAcceptedEvent apply(QuickEvent evt) {
