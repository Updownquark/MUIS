...
/**
 * An event that occurs when the user performs an action with the mouse over a WAM element
 */
public class MouseEvent extends PositionedUserEvent
{
	...
	public static enum MouseEventType
	{
		...
		BUTTON_UP,
		/**
		 * Represents the user pressing and releasing a mouse button quickly without moving the
		 * mouse pointer
		 */
		BUTTON_CLICKED,
		/**
	 ...
	 */
	public MouseEvent(WamDocument doc, WamElement element, MouseEventType type, int docX, int docY,
		ButtonType buttonType, int clickCount)
	{
		super(WamElement.MOUSE_EVENT, doc, element, docX, docY);
		theType = type;
