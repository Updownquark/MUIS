...
/**
 * A MUIS element that serves as a placeholder for text content which may be interspersed with
 * element children in an element.
 */
public class MuisTextElement extends MuisElement implements Splittable
{
