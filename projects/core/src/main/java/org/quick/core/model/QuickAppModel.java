...
public interface QuickAppModel {
	 ...
	 */
	QuickAppModel getSubModel(String name);
	 ...
	 */
	<T extends QuickWidgetModel> T getWidgetModel(String name, Class<T> modelType) throws ClassCastException;
	 ...
	 */
	QuickActionListener getAction(String name);
}
