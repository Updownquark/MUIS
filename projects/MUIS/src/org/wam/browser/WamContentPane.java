...
import org.wam.core.event.KeyBoardEvent.KeyCode;
import org.wam.core.event.MouseEvent.MouseEventType;

/**
 * An AWT component that renders a WAM document
 */
public class WamContentPane extends java.awt.Component
{
	private org.wam.core.WamDocument theContent;

	/**
	 * Creates a WamContentPane
	 */
	public WamContentPane()
	{
		super();
	 ...
	 */
	public void setContent(org.wam.core.WamDocument doc)
	{
		theContent = doc;
	}
	...
	void moused(org.wam.core.event.MouseEvent.MouseEventType type, MouseEvent evt)
	{
		if(theContent == null)
			return;
		org.wam.core.event.MouseEvent.ButtonType buttonType;
		switch(evt.getButton())
		{
		case MouseEvent.NOBUTTON:
			buttonType = org.wam.core.event.MouseEvent.ButtonType.NONE;
			break;
		case MouseEvent.BUTTON1:
			buttonType = org.wam.core.event.MouseEvent.ButtonType.LEFT;
			break;
		case MouseEvent.BUTTON2:
			buttonType = org.wam.core.event.MouseEvent.ButtonType.MIDDLE;
			break;
		case MouseEvent.BUTTON3:
			buttonType = org.wam.core.event.MouseEvent.ButtonType.RIGHT;
			break;
		default:
			buttonType = org.wam.core.event.MouseEvent.ButtonType.OTHER;
			break;
		}
	...
	void keyed(Boolean pressed, KeyEvent evt)
	{
		if(theContent == null)
			return;
		if(pressed != null)
			theContent.keyed(getKeyCodeFromAWT(evt.getKeyCode(), evt.getKeyLocation()), pressed
				.booleanValue());
		else
	 ...
	 * @param keyLocation The key's location (see java.awt.KeyEvent.KEY_LOCATION_*,
	 *        {@link KeyEvent#getKeyLocation()}
	 * @return The WAM key code for the AWT codes
	 */
