...
public class DocumentStyleSheet extends AbstractStyleSheet {
	...
	public DocumentStyleSheet(org.muis.core.MuisDocument doc) {
		super(new org.observe.collect.DefaultObservableList<>(new prisms.lang.Type(StyleSheet.class)));
		theDependencyController = ((org.observe.collect.DefaultObservableList<StyleSheet>) getConditionalDependencies()).control(null);
		theDoc = doc;
