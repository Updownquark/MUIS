...
public class LayoutContainerWidget extends QuickWidget {
	public LayoutContainerWidget(QuickWidgetDocument doc, LayoutContainer element, QuickWidget parent) {
	...
	@Override
	public LayoutContainer getElement() {
		return (LayoutContainer) super.getElement();
	}
