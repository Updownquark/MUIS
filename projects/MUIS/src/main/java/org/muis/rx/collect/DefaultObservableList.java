 ...
 * {@link #control(org.muis.rx.DefaultObservable.OnSubscribe)} to obtain a list controller. This controller can be modified and these
...
public class DefaultObservableList<E> extends AbstractList<E> implements ObservableList<E>, RandomAccess {
	 ...
	 */
	public List<E> control(org.muis.rx.DefaultObservable.OnSubscribe<ObservableElement<E>> onSubscribe) {
