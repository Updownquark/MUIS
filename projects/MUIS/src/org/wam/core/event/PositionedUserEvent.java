...
public class PositionedUserEvent extends UserEvent
{
	 ...
	 */
	public PositionedUserEvent(WamEventType<Void> type, org.wam.core.WamDocument doc,
		WamElement element, int docX, int docY)
	{
	 ...
	 *         given element
	 */
	public java.awt.Point getRelativePosition(WamElement element)
	{
		int x = theDocumentX;
		int y = theDocumentY;
		WamElement last = element;
		while(element != null)
		{
			x -= element.getX();
			y -= element.getY();
