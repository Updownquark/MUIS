...
public interface WamLayout
{
	 ...
	 */
	void initChildren(WamElement parent, WamElement [] children);
	 ...
	 *         horizontally
	 */
	SizePolicy getWSizer(WamElement parent, WamElement [] children, int parentHeight);
	 ...
	 *         vertically
	 */
	SizePolicy getHSizer(WamElement parent, WamElement [] children, int parentWidth);
	 ...
	 *        implementation of {@link WamContainer}.
	 ...
	 */
	void layout(WamElement parent, WamElement [] children, java.awt.Rectangle box);
