...
/**
 * A WamPermission is a request or a requirement for a toolkit to use a capability. According to the
...
public class WamPermission
{
	...
	/**
	 * Creates a WAM Permission request
	 * 
	 ...
	 */
	public WamPermission(Type _type, SubType _subType, String [] paramValues, boolean req,
		String explain)
	{
		type = _type;
		subType = _subType;
