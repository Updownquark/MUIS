...
public class MouseEvent extends PositionedUserEvent {
	 ...
	 */
	public MouseEvent(QuickWidgetDocument doc, QuickWidget target, MouseEventType type, ButtonType button, int clickCount,
	...
	@Override
	public MouseEvent copyFor(QuickWidget widget) {
		QuickEventPositionCapture capture = getCapture().find(widget);
		if(capture == null)
	...
	public String toString() {
		return "Mouse " + theType + " with " + theButton + (theClickCount > 1 ? " x" + theClickCount : "") + " at " + getWidget();
	}
}
