...
public class QuickEventPositionCapture extends QuickElementCapture {
	 ...
	 */
	public QuickEventPositionCapture(QuickEventPositionCapture p, QuickWidget widget, int xPos, int yPos, int zIndex, int w, int h,
		int evtX, int evtY) {
		super(p, widget, xPos, yPos, zIndex, w, h);
		theEventX = evtX;
		theEventY = evtY;
	}
	...
	@Override
	public QuickEventPositionCapture find(QuickWidget widget) {
		return (QuickEventPositionCapture) super.find(widget);
	}
