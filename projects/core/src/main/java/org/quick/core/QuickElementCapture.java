...
public class QuickElementCapture implements Cloneable, org.qommons.Sealable {
	 ...
	 */
	public QuickElementCapture(QuickElementCapture p, QuickElement el, int xPos, int yPos, int zIndex, int w, int h) {
	 ...
	 * @param h The height of the element
	 */
	public QuickElementCapture(QuickElementCapture p, QuickElement el, Transformer transformer, int xPos, int yPos, int zIndex, int w, int h) {
		theParent = p;
		theElement = el;
	 ...
	 */
	public QuickElementCapture find(QuickElement el) {
		if(theParent != null)
			return getRoot().find(el);
		QuickElement [] path = QuickUtils.path(el);
	...
	public final boolean equals(Object obj) {
		return obj instanceof QuickElementCapture && ((QuickElementCapture) obj).getElement().equals(getElement());
	}
	...
	protected QuickEventPositionCapture createCapture(QuickEventPositionCapture parent, Point pos) {
		return new QuickEventPositionCapture(parent, getElement(), theX, theY, theZ, theWidth, theHeight, pos.x, pos.y);
	}
