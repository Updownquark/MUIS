...
/**
 * A QuickPermission is a request or a requirement for a toolkit to use a capability. According to the environment's security policy, these
...
public class QuickPermission {
	 ...
	 */
	public QuickPermission(Type _type, SubType _subType, String [] paramValues, boolean req, String explain) {
		type = _type;
		subType = _subType;
