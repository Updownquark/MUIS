 ...
 * attributes so that the parser will call the {@link #attach(WamElement)} method, allowing user
 * code to run on the element.
 */
public interface WamElementAttachment
{
	/**
	 ...
	 */
	void attach(WamElement element);
}
