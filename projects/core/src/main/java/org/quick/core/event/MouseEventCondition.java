...
import org.quick.core.event.MouseEvent.ButtonType;
...
public class MouseEventCondition extends PositionedUserEventCondition<MouseEvent> {
	...
	public static java.util.function.Function<QuickEvent, MouseEvent> base = value -> {
	...
	@Override
	public MouseEvent apply(QuickEvent evt) {
