...
public class PositionedUserEventCondition<E extends PositionedUserEvent> extends UserEventCondition<E> {
	...
	protected static java.util.function.Function<QuickWidgetEvent, PositionedUserEvent> base = value -> {
	 ...
	 */
	protected PositionedUserEvent positionedApply(QuickWidgetEvent event) {
		return base.apply(userApply(event));
	}

	/* Should be overridden by subclass */
	@Override
	public E apply(QuickWidgetEvent evt) {
