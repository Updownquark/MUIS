 ...
 *
 * A sorted set whose content can be observed. This set is immutable in that none of its methods, including {@link Set} methods, can modify
 * its content (Set modification methods will throw {@link UnsupportedOperationException}). To modify the list content, use
 * {@link #control(org.muis.rx.DefaultObservable.OnSubscribe)} to obtain a set controller. This controller can be modified and these
