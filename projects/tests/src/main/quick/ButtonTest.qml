...
<quick xmlns:base="../../../../base/QuickRegistry.xml" xmlns:test="../../../QuickRegistry.xml">
    ...
    <body layout="base:simple">
    	<block layout="simple" width="100%" top="0" height="100%">
			...
			<button left="0" right="100%" top="25%" height="50%" action="model.counter--">
			...
			<block left="3" right="3xp" top="75%" height="25%" style="bg.color=blue">This block should change color with button clicks</block>
    	</block>
    </body>
</quick>
