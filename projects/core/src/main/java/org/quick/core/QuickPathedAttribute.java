 ...
 */
public class QuickPathedAttribute<T> extends QuickAttribute<T> {
	private final QuickAttribute<T> theBase;
	 ...
	 */
	public QuickPathedAttribute(QuickAttribute<T> attr, QuickElement element, String... path) throws IllegalArgumentException {
	...
	public QuickAttribute<T> getBase() {
		return theBase;
	}
